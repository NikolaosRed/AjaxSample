...
namespace WebAPI.Controllers
{
    ...
    {
        public ProductController(ProductDbContext context): base()
        {
            _DbContext = context;
        }
        ...
        public IActionResult Post(Product entity)
        {
            ...
            {
                ret = HandleException(ex, "Exception trying to insert a new " + ENTITY_NAME + ".");
            }
        ...
        public IActionResult Put(int id, Product entity)
        {
            ...
            try
            {
                if (entity != null)
                {
                    ...
                    {
                        ret = StatusCode(StatusCodes.Status404NotFound, "Can't find ProductID=" + id.ToString());
                    }
                }
                else
                {
            ...
            catch (Exception ex)
            {
                ret = HandleException(ex,
                      "Exception trying to update " + ENTITY_NAME + " ID: "+ entity.ProductID.ToString() + ".");
            }
